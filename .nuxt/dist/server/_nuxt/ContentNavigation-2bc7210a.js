...
import "hookable";
import { q as queryContent, e as encodeQueryParams, j as jsonStringify, u as useAsyncData } from "./query-416276db.js";
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import("./client-db-fa6da03f.js").then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-2bc7210a.js.map

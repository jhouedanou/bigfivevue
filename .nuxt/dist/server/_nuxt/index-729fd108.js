...
const index_vue_vue_type_style_index_0_scoped_7d35072d_lang = "";
const _sfc_main = {
  __name: "index",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="col-9 primary-bg vh-100" data-v-7d35072d><div class="swiper" data-v-7d35072d><div class="swiper-wrapper" data-v-7d35072d><div id="slide1" class="swiper-slide" data-v-7d35072d><h3 data-v-7d35072d>${ssrInterpolate(((_b = (_a = state.agence) == null ? void 0 : _a.slide1) == null ? void 0 : _b.title) ?? "")}</h3><p data-v-7d35072d>${((_d = (_c = state.agence) == null ? void 0 : _c.slide1) == null ? void 0 : _d.soustitre) ?? ""}</p><h3 data-v-7d35072d>${ssrInterpolate(((_f = (_e = state.agence) == null ? void 0 : _e.slide1) == null ? void 0 : _f.contenu) ?? "")}</h3></div><div id="slide2" class="swiper-slide" data-v-7d35072d><div class="row slide-inner" data-v-7d35072d><!--[-->`);
      ssrRenderList(((_g = state.agence) == null ? void 0 : _g.slide2) ?? [], (slide) => {
        _push(`<div class="col-4" data-v-7d35072d><img${ssrRenderAttr("src", ("getIconPath" in _ctx ? _ctx.getIconPath : unref(getIconPath))(slide.img ?? ""))} alt="" data-v-7d35072d><h3 data-v-7d35072d>${ssrInterpolate(slide.title ?? "")}</h3><p data-v-7d35072d>${slide.content ?? ""}</p></div>`);
      });
      _push(`<!--]--></div></div><div id="slide3" class="swiper-slide" data-v-7d35072d><p data-v-7d35072d>${((_h = state.agence) == null ? void 0 : _h.introslide3) ?? ""}</p><div id="swide" data-v-7d35072d><!--[-->`);
      ...
      _push(`<!--]--></ul></div><div id="slide5" class="swiper-slide" data-v-7d35072d><div id="mouf" data-v-7d35072d>${((_k = state.agence) == null ? void 0 : _k.slide5) ?? ""}</div></div></div><div class="swiper-pagination" data-v-7d35072d></div></div></div></div></div>`);
    };
  }
};
...
//# sourceMappingURL=index-729fd108.js.map

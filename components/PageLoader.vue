<template>
	<div class="page-loader">
		...
		<svg class="elementToFadeInAndOut"
			version="1.1"
		...
		c1.4,0,2.3-0.8,2.3-2.1c0-1.3-0.8-2.1-2.3-2.1h-1.7v4.2H220.5z"
			...
			<g id="logo_BIGFIVE_ARRONDI-2"
				transform="translate(-1337 -56.479)">

				<linearGradient id="Tracé_29_00000170978168080911548840000011368567735691841213_"
					...
					<stop offset="0"
						style="stop-color:#82368C"></stop>
					<stop offset="1"
						style="stop-color:#27348B"></stop>
				</linearGradient>
				<path id="Tracé_29"
					style="fill: url(&quot;#Tracé_29_00000170978168080911548840000011368567735691841213_&quot;);"
					d="M1408.5,238.6
		...
		c3.1-0.1,5.6-2.7,5.5-5.8c0-3-2.4-5.5-5.4-5.5c0,0-0.1,0-0.1,0h-21V91.2z"></path>
				<path id="Union_1"
					class="st2 svg-elem-25"
					d="M1482,238.6L1482,238.6l-34.4-93.1h32l19.9,62.6l19.9-62.6h32l-34.4,93.1H1482z M1553.5,238.6
